 ...
 */
@Autonomous(name = "dont run (right)", group = "advanced")
public class AutoBlue1and4maybe extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory trajectory2 = drive.trajectoryBuilder(trajectory1.end())
                ...
                .splineToConstantHeading(new Vector2d(60, -9.7), Math.toRadians(0))
        ...
        TrajectorySequence trajectory3 = drive.trajectorySequenceBuilder(new Pose2d(60, -12, Math.toRadians(0)))
        ...
        // Second trajectory
        // Ensure that we call trajectory1.end() as the start for this one
        Trajectory trajectory4 = drive.trajectoryBuilder(new Pose2d(28.3, 1, Math.toRadians(0)))
                .addTemporalMarker(0.25, () -> {
                    // This marker runs two seconds into the trajectory
                    // Run your action in here!
                    arm.setPower(-0.2);
                ...
                .splineToConstantHeading(new Vector2d(59.3, -11.5), Math.toRadians(0))
                .addDisplacementMarker(() -> {
                    // This marker runs 20 inches into the trajectory
                    // Run your action in here!
                    claw.setPosition(OPEN_CLAW);
        ...
        TrajectorySequence trajectory5 = drive.trajectorySequenceBuilder(new Pose2d(59.3, -12, Math.toRadians(0)))
                .lineToConstantHeading(new Vector2d(55, -12))
                .splineToConstantHeading(new Vector2d(30, 4.5), Math.toRadians(90))
                .addTemporalMarker(1, () -> {
                    // This marker runs two seconds into the trajectory
                    // Run your action in here!
                    arm.setPower(0.2);
        ...
        // Second trajectory
        // Ensure that we call trajectory1.end() as the start for this one
        Trajectory trajectory6 = drive.trajectoryBuilder(new Pose2d(28.3, 1, Math.toRadians(0)))
                .addTemporalMarker(0.25, () -> {
                    // This marker runs two seconds into the trajectory
                    // Run your action in here!
                    arm.setPower(-0.2);
                ...
                .splineToConstantHeading(new Vector2d(59.8, -9.5), Math.toRadians(0))
                .addDisplacementMarker(() -> {
                    // This marker runs 20 inches into the trajectory
                    // Run your action in here!
                    claw.setPosition(OPEN_CLAW);
        ...
        TrajectorySequence trajectory7 = drive.trajectorySequenceBuilder(new Pose2d(59.8, -12, Math.toRadians(0)))
                .lineToConstantHeading(new Vector2d(55, -12))
                .splineToConstantHeading(new Vector2d(30, 3.5), Math.toRadians(90))
                .addTemporalMarker(1, () -> {
                    // This marker runs two seconds into the trajectory
                    // Run your action in here!
                    arm.setPower(0.2);
            ...
            switch (currentState) {
                case TRAJECTORY_1:
                    ...
                    if (!drive.isBusy()) {
                        ...
                        drive.setPoseEstimate(new Pose2d(new Vector2d(28.3, 1), Math.toRadians(0)));
                        waitTimer1.reset();
                        timer.reset();
                    }
                    break;
                ...
                case WAIT_3:
                    ...
                    if (waitTimer1.seconds() >= 0.6) {
                        ...
                        drive.setPoseEstimate(new Pose2d(59.3 , -12, Math.toRadians(0)));
                ...
                case WAIT_5:
                    ...
                    if (waitTimer1.seconds() >= 0.5) {
                        ...
                        drive.setPoseEstimate(new Pose2d(59.8, -12, Math.toRadians(0)));
