...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static double LATERAL_MULTIPLIER = 30.0 / 22.75 * 60 / 48.75;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        // for instance, setLocalizer(new StandardTrackingWheelLocalizer(hardwareMap));
        setLocalizer(new StandardTrackingWheelLocalizer(hardwareMap));//TwoWheelTrackingLocalizer(hardwareMap, this));
