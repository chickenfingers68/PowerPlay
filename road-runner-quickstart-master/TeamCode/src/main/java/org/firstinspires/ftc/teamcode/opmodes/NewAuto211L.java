...
public class NewAuto211L extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory trajectory1 = drive.trajectoryBuilder(startPose)
                ...
                .lineToLinearHeading(new Pose2d(-31.5, -20, Math.toRadians(177)))
        ...
        // Second trajectory
        // Ensure that we call trajectory1.end() as the start for this one
        Trajectory trajectory4 = drive.trajectoryBuilder(new Pose2d(-6.2, -24, Math.toRadians(180)))
                .addTemporalMarker(0.25, () -> {
                    // This marker runs two seconds into the trajectory
                    // Run your action in here!
                    arm.setPower(-0.2);
        ...
        TrajectorySequence trajectory7 = drive.trajectorySequenceBuilder(new Pose2d(-56.75, -12, Math.toRadians(180)))
            ...
            switch (currentState) {
                ...
                case WAIT_2:
                    ...
                    if (waitTimer1.seconds() >= 1.3) {
                        ...
                        drive.setPoseEstimate(new Pose2d(new Vector2d(-6.2, -24), Math.toRadians(180)));
