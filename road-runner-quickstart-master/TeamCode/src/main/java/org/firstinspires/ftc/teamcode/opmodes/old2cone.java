...
public class old2cone extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive() && !isStopRequested()) {
            ...
            runtime.reset();
            //move towards pole
            while ((Math.abs(Math.abs(back_left.getCurrentPosition()) - 40.5 * COUNTS_PER_INCH * 30.0 / 30.75) > 15) &&
                    (Math.abs(Math.abs(back_right.getCurrentPosition()) - 40.5 * COUNTS_PER_INCH * 30.0 / 30.75) > 15) &&
                    (Math.abs(Math.abs(front_left.getCurrentPosition()) - 40.5 * COUNTS_PER_INCH * 30.0 / 30.75) > 15) &&
                    (Math.abs(Math.abs(front_right.getCurrentPosition()) - 40.5 * COUNTS_PER_INCH * 30.0 / 30.75) > 15) &&
                    opModeIsActive()) {
