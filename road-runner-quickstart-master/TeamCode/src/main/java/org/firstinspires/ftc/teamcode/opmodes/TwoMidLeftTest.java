...
@Autonomous(name = "kjfgbjhsbghjsfbbgkj")
@Disabled
public class TwoMidLeftTest extends LinearOpMode {
    //Time
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive() && !isStopRequested()) {
            ...
            while ((Math.abs(Math.abs(back_left.getCurrentPosition()) - 40.15 * COUNTS_PER_INCH) > 15) &&
                    (Math.abs(Math.abs(back_right.getCurrentPosition()) - 40.15 * COUNTS_PER_INCH) > 15) &&
                    (Math.abs(Math.abs(front_left.getCurrentPosition()) - 40.15 * COUNTS_PER_INCH) > 15) &&
                    (Math.abs(Math.abs(front_right.getCurrentPosition()) - 40.15 * COUNTS_PER_INCH) > 15) &&
                    opModeIsActive()) {
                arm_left.setPower(0.03);
                arm_right.setPower(0.03);
                correction = checkDirection();
            ...
            while((Math.abs(Math.abs(back_left.getCurrentPosition()) - 16 * COUNTS_PER_INCH ) > 9) &&
                    (Math.abs(Math.abs(back_right.getCurrentPosition()) - 16 * COUNTS_PER_INCH ) > 9) &&
                    (Math.abs(Math.abs(front_left.getCurrentPosition()) - 16 * COUNTS_PER_INCH ) > 9) &&
                    (Math.abs(Math.abs(front_right.getCurrentPosition()) - 16 * COUNTS_PER_INCH ) > 9) &&
                    opModeIsActive()){
            ...
            if(location==1){
                ...
                encoderFunction();
                //move back a bit
                while((Math.abs(Math.abs(back_left.getCurrentPosition()) - 27 * COUNTS_PER_INCH ) > 20) &&
                        (Math.abs(Math.abs(back_right.getCurrentPosition()) - 27 * COUNTS_PER_INCH ) > 20) &&
                        (Math.abs(Math.abs(front_left.getCurrentPosition()) - 27 * COUNTS_PER_INCH ) > 20) &&
                        (Math.abs(Math.abs(front_right.getCurrentPosition()) - 27 * COUNTS_PER_INCH ) > 20) &&
                        opModeIsActive()){
