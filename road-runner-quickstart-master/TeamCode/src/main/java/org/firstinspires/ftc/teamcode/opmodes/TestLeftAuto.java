...
@Autonomous(name = "LEFTold", preselectTeleOp = "ActualTeleOp")
@Disabled
public class TestLeftAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive() && !isStopRequested()) {
            ...
            encoderFunction();
            //move back a bit
            while((Math.abs(Math.abs(back_left.getCurrentPosition()) - 2.75 * COUNTS_PER_INCH ) > 9) &&
                    (Math.abs(Math.abs(back_right.getCurrentPosition()) - 2.75 * COUNTS_PER_INCH ) > 9) &&
                    (Math.abs(Math.abs(front_left.getCurrentPosition()) - 2.75 * COUNTS_PER_INCH ) > 9) &&
                    (Math.abs(Math.abs(front_right.getCurrentPosition()) - 2.75 * COUNTS_PER_INCH ) > 9) &&
                    (Math.abs(Math.abs(front_right.getCurrentPosition()) - 2.75 * COUNTS_PER_INCH ) > 9) &&
                    opModeIsActive()){
            ...
            while((Math.abs(Math.abs(back_left.getCurrentPosition()) - 17 * COUNTS_PER_INCH ) > 9) &&
                    (Math.abs(Math.abs(back_right.getCurrentPosition()) - 17 * COUNTS_PER_INCH ) > 9) &&
                    (Math.abs(Math.abs(front_left.getCurrentPosition()) - 17 * COUNTS_PER_INCH ) > 9) &&
                    (Math.abs(Math.abs(front_right.getCurrentPosition()) - 17 * COUNTS_PER_INCH ) > 9) &&
                    opModeIsActive()){
            ...
            if(location==1){
                ...
                setPZero();
                /*
                while((Math.abs(Math.abs(back_left.getCurrentPosition()) - 9.75 * COUNTS_PER_INCH ) > 9) &&

                        (Math.abs(Math.abs(back_right.getCurrentPosition()) - 9.75 * COUNTS_PER_INCH ) > 9) &&
                        (Math.abs(Math.abs(front_left.getCurrentPosition()) - 9.75 * COUNTS_PER_INCH ) > 9) &&
                        (Math.abs(Math.abs(front_right.getCurrentPosition()) - 9.75 * COUNTS_PER_INCH ) > 9) &&
                        opModeIsActive()){
